...
const DropDownInput = (props: FormInputProps) => {
  const writeClass = props.readonly
    ? "cursor-default"
    : "cursor-pointer px-3 py-2 border border-slate-300 shadow-sm focus:text-slate-600 focus:border-sky-500 focus:ring-1 focus:ring-sky-500";
...
const Input = (props: FormInputProps) => {
  ...
  const writeClass = props.readonly
    ...
    : "px-3 py-2 border border-slate-300 shadow-sm focus:text-slate-600 focus:border-sky-500 focus:ring-1 focus:ring-sky-500";
