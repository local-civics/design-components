        ...
        >
            ...
            <div className="p-2">
                <div className="flex items-center">
                    ...
                    {props.onSeeAll && <p onClick={props.onSeeAll} className="text-xs align-middle cursor-pointer text-gray-400 hover:text-gray-600 inline-block">
                        See All
                    </p>}
                </div>
                                ...
                                >
                                    ...
                                    {event.notBefore && (
                                        <p className="mt-3 text-xs">
                                            {new Date(event.notBefore).toLocaleString(
                                                "default",
                                                {
                                                    month: "short",
                                                    day: "2-digit",
