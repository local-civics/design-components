    ...
    return (
        <>
            ...
            <Gallery
                ...
                top={
                    !props.search && props.top && props.top.length > 0 && (
                ...
                soonest={
                    !props.search && props.upcoming && props.upcoming.length > 0 && (
                        <article className="grid grid-cols-1 md:flex gap-2 overflow-scroll">
                ...
                milestones={
                    !props.search && props.milestones && props.milestones.length > 0 && (
                        <article className="grid grid-cols-1 md:flex gap-2 overflow-scroll">
