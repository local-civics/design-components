 ...
 * @constructor
 */
export const PassportWidget: FunctionComponent<PassportWidgetProps> = (props) => {
    const [passport, isLoading] = usePassport(props.username)
    return (
                    ...
                    <div>
                        ...
                        <div className="mt-2 flex">
                            <div className="flex-grow">
                                ...
                                <p className="ml-2 text-gray-700 text-xl inline-block">
                                    XP
                                </p>
                            </div>
                            {passport.xp &&
