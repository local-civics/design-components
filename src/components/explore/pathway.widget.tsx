      ...
      <div className="grid grid-cols-1 h-full">
        ...
        <div className="grid grid-cols-1">
          {pathways.map((pathway, i) => {
            const base =
              "px-2 py-4 text-left cursor-pointer hover:bg-white active:bg-white";
            ...
            return (
              ...
              >
                <Icon
                  className="inline-block w-4 h-4 min-w-4 stroke-slate-600 fill-slate-600"
                  icon={pathway}
                />
                <span className="ml-2 capitalize font-semibold text-sm text-slate-600">
                  {" "}
                  {pathway}{" "}
                </span>
              </button>
