    ...
    <div className="grid grid-cols-1 w-64 gap-y-3">
      <div className="flex flex-col h-64 w-64 overflow-hidden border border-zinc-100 rounded-md bg-gray-100">
        ...
        >
          ...
          <div
            className={`absolute overflow-hidden left-0 right-0 top-0 bottom-0 m-auto text-dark-blue-400 ${centerpieceHeight}`}
          >
        ...
        {hasProgress && (
          <div className="grow grid grid-cols-1 gap-2 w-full h-20 bg-white shadow-sm p-4">
            <div className="h-2">
              <Progress rounded color="sky-blue" start={props.progress} end={props.target} />
            </div>
            {
              <p className="text-xs">
