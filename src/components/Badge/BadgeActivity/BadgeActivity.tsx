        ...
        <div className="w-[20rem]">
            ...
            <div className="px-2 pt-5 pb-5 text-zinc-600 grid grid-cols-1 gap-y-5">
                <div className="flex gap-x-2">
                    ...
                    <div className="h-max py-2 px-5 rounded-md bg-sky-300 font-semibold">
                        { props.xp }pts
                    </div>
                </div>
                ...
                <div className="flex">
                    <div className="ml-auto flex">
                        <span className="my-auto h-max text-sm">
                            { iconLabel }
                        </span>
                        <div onClick={props.onToggle} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} className={`ml-2 inline-block cursor-pointer h-8 w-8 ${iconColor}`}>
                            <Icon name={iconName}/>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex gap-x-2">
                    { tags.map((tag, i) => {
                        return <div key={i} className="rounded-md shadow-sm py-2 px-3 bg-zinc-100 text-sm">
                            { tag }
                        </div>
                    })}
                </div>
