...
import {Activity, ListActivities, ListActivitiesProps} from "./ListActivities";
 ...
 */
export default {
  title: "Admin/Activities/ListActivities",
 ...
 */
const Template: Story<ListActivitiesProps> = (args) => {
 ...
 * Component stories
 */
export const Component: Story<ListActivitiesProps> = Template.bind({});
Component.args = {};
