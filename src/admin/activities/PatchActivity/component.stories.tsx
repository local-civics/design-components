...
import {PatchActivity, PatchActivityProps, Activity} from "./PatchActivity";
 ...
 */
export default {
  title: "Admin/Activities/PatchActivity",
  component: PatchActivity,
};

/**
 * Component storybook template
 */
const Template: Story<PatchActivityProps> = (args) => {
 ...
 * Component stories
 */
export const Component: Story<PatchActivityProps> = Template.bind({});
Component.args = {};
