 ...
 * ManageOrganizations
 */
export type ManageOrganizationsProps = {
 ...
 * @constructor
 */
export const ManageOrganizations = (props: ManageOrganizationsProps) => {
...
type OrganizationItemProps = ManageOrganizationsProps & ManagedOrganization & {
    activeId?: string;
