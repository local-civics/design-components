...
import {ManageBundle, ManageBundleProps} from "../ManageBundle/ManageBundle";

export type ManageBundlesTab = "All bundles" | "My bundles" | "Installed bundles"
const TABS: ManageBundlesTab[] = ["All bundles", "My bundles", "Installed bundles"]
const DEFAULT_TAB: ManageBundlesTab = "All bundles"

/**
 * ManageBundles
 */
export type ManageBundlesProps = {
    loading?: React.ReactNode
    tab?: ManageBundlesTab
    bundles?: ManagedBundle[]

    onTabChange?: (tab: ManageBundlesTab) => Promise<void>;
    onSearch?: (value: string) => void;
    onBundleClick?: (bundle: ManagedBundle) => void;
    onCreateBundle?: (bundle: NewBundle) => Promise<void>;
    onDeleteBundle?: (bundle: ManagedBundle) => Promise<void>;
    onInstallBundle?: (bundle: ManagedBundle) => Promise<void>;
    onUninstallBundle?: (bundle: ManagedBundle) => Promise<void>;
    onMoreBundles?: () => void;
}
 ...
 * @constructor
 */
export const ManageBundles = (props: ManageBundlesProps) => {
...
type manageBundlesProps = ManageBundlesProps & {
    tabLoading?: boolean
    activeId?: string;
    setActiveId: (activeId: string) => void;
}

const Navigation = (props: manageBundlesProps) => {
...
const Body = (props: manageBundlesProps) => {
    const bundles = props.bundles || []
    const [manage, setManage] = React.useState(null as ManageBundleProps | null)
    ...
    const onBundleClick = (bundle: ManagedBundle) => {
        setManage({
            ...bundle,
            onDelete: async () => {
...
type BundleItemProps = manageBundlesProps & ManagedBundle
