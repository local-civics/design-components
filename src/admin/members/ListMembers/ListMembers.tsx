...
export type ListMembersProps = {
    ...
    onRenameMember?: (member: Member, displayName: string) => Promise<void>;
    onChangeMemberRole?: (member: Member, role: string) => Promise<void>;
 ...
 * @constructor
 */
export const ListMembers = (props: ListMembersProps) => {
...
type MemberItemProps = ListMembersProps & Member & {
    activeId?: string;
