...
import {ManageProjectsTab}                               from "../../projects/ManageProjects/ManageProjects";
...
export type AdminPageName = "Home" | "Organizations" |
    "Insights" | "Classes" | "Members" |  "Settings" | "Projects" |
    "Curricula" | "Activities" | "Badges"
const PAGES: AdminPageName[] = ["Home", "Organizations", "Members", "Projects", "Curricula", "Classes", "Insights", "Settings"]
...
export type AdminPageParams = {
    ...
    projectTab?: ManageProjectsTab

    onManageProjectsTabChange?: (next: ManageProjectsTab) => Promise<void>
}
