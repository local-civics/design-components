 ...
 * @constructor
 */
export const ListCriteria = (props: ListCriteriaProps) => {
    ...
    const onRequirementPreviewClick = (r: Criterion) => setRequirementPreview(<RequirementPreview
        {...r}
...
type RequirementItemProps = ListCriteriaProps & Criterion & {
    number: number
    activeNumber?: number;
...
type RequirementPreviewProps = Criterion & {
    onCancel?: () => void
}
