 ...
 * ManageActivities
 */
export type ManageActivitiesProps = {
 ...
 * @constructor
 */
export const ManageActivities = (props: ManageActivitiesProps) => {
...
type ActivityItemProps = ManageActivitiesProps & ManagedActivity & {
    activeId?: string;
