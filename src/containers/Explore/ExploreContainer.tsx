...
const useActivities = (tenantName: string, query: ActivityQuery) => {
    ...
    React.useEffect(() => {
        ...
        (async () => {
            ...
            setActivities(await api.do(ctx, "GET", "curriculum", `/tenants/${tenantName}/activities`, {
                query: query
            }))
        })();
...
const useRecommendation = (tenantName: string, query: ActivityQuery) => {
    ...
    React.useEffect(() => {
        ...
        (async () => {
            const ctx = {referrer: location.pathname}
            setRecommendation(await api.do(ctx, "GET", "curriculum", `/tenants/${tenantName}/recommendations`, {
                query: query
            }))
        })();
