...
import {ManagedStudent, ManageRoster, ManageRosterProps} from "./ManageRoster";
 ...
 */
const Template: Story<ManageRosterProps> = (args) => {
    const now = new Date()

    const roster: ManagedStudent[] = [{
 ...
 * Component stories
 */
export const Component: Story<ManageRosterProps> = Template.bind({});
Component.args = {};
