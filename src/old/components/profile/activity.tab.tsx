              ...
              >
                <div className="w-full py-4 px-4">
                  ...
                  <div className="align-middle ml-2 inline-block">
                    <p className="font-semibold capitalize text-slate-600 text-md">{event.title}</p>
                    <div className="text-xs">
                      <p className="inline-block capitalize text-slate-600">{event.pathway}</p>
                      {event.proficiency && (
                        <p className="ml-1 font-semibold inline-block text-green-500">{event.proficiency} pts</p>
                      )}
                    </div>
                  </div>
                </div>
                <img className="w-full object-cover h-64" alt={event.title} src={event.imageURL} />
