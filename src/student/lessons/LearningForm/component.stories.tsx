 ...
 */
export default {
    title: "Student/Lessons/LearningForm",
...
const communityMappingOfSelfForm: LearningFormProps = {
    ...
    "description": "Knowing your personal strengths or assets can help you overcome challenges, grow, and achieve your goals. \n\nIn this activity, you will identify others’ personal assets, map your personal assets and share examples of how you have used or will use your assets.\n",
    "imageURL": "https://uploads-ssl.webflow.com/5ead22f7b41a94042ab113cd/623a0f002dd6fe190044d4e8_policy%20power%20mapping.png",
    "reflection": "Some example input to test out badge completion as well as ability to save form answers and well this. Some example input to test out badge completion as well as ability to save form answers and well this. ",
    "rating": 4,
    "eta": "30m",
    "items": [
        {
            "itemId": "56cf653f-b224-4864-8e1d-73161420d3ad",
            "displayName": "WARM-UP: Watch the following videos about examples of civic engagement and answer the questions that follow. ",
            "format": "text"
        },
        {
        ...
        },
        {
            ...
            "displayName": "You can also review the list of character strengths using this link: https://www.face.edu/site/handlers/filedownload.ashx?moduleinstanceid=39059&dataid=61397&FileName=24-Character-Strengths.pdf",
            "format": "text"
        },
        {
        ...
        },
        {
            ...
            "displayName": "1b. Are peoples’ strengths or assets “fixed” meaning they are born with certain assets and can’t change them?",
            "description": "(1-2 sentences)",
            "format": "question",
            "questionType": "text",
            "paragraph": true,
        ...
        },
        {
            ...
            "displayName": "Listen to each of these stories and list the assets you believe each storyteller may have and why. ",
            "format": "text"
        },
        {
        ...
        },
        {
            ...
            "displayName": "Assets or strengths can include specific knowledge or skills like language fluency or math skills or personality characteristics or traits like empathy or kindness. Watch the following video where Shayna shares a map of her assets and discusses how you can identify your assets. ",
            "format": "embed",
        ...
        },
        {
            ...
            "displayName": "3b. Shayna's asset map mainly focused on her characteristics or traits. Which of the following is a skill she shared on her asset map? ",
            "format": "question",
            "questionType": "radio",
            "options": [
                "A. Teaching",
        ...
        },
        {
            ...
            "displayName": "4c. Choose one asset and give an example of how you have used this asset. The asset can be a characteristics or a skill or knowledge you have. ",
            "description": "(1-2 sentences)",
            "format": "question",
            "questionType": "text",
            "paragraph": true,
        ...
        },
        {
            ...
            "displayName": "5a. Take the following survey and share your results — https://www.viacharacter.org/survey/account/register?registerPageType=popup",
            "format": "question",
