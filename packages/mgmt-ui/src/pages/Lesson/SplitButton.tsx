...
export type SplitButtonProps = {
    href: string
    noExport?: boolean
    // True while the page's own activity fan-out (student/question completion data) is still
    // loading - the header/title resolve first and the page stops showing its own loading overlay
    // well before this second fetch finishes, so without this the button was clickable into a
    // header-only CSV.
